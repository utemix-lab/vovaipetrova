...
export const VISUAL_CONFIG = {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ОКНА ИНТЕРФЕЙСА (windows)
  // !STABLE — НЕ ТРОГАТЬ БЕЗ СОГЛАСОВАНИЯ
  // Единый источник данных для названий, подсказок и заголовков окон
  // Источник: docs/UI_STANDARDS.md#окна-интерфейса
  // ═══════════════════════════════════════════════════════════════════════════
  windows: {
    // Постоянные окна
    scope: {
      title: "Scope",
      hint: "Главное окно навигации",
      description: "Главное окно навигации по графу"
    },
    system: {
      title: "System",
      hint: "Системная информация",
      description: "Системная информация"
    },
    service: {
      title: "Service",
      hint: "Сервисные функции",
      description: "Сервисные функции"
    },
    // Вложенные окна
    story: {
      title: "Story",
      hint: "Мини-окно с ассетом",
      description: "Мини-окно с 3D-фигурой и ассетом"
    },
    // Вызываемые окна (вспомогательные)
    slate: {
      title: "Slate",
      hint: "Новостная лента",
