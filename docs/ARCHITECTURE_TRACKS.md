...
| Персонаж | В Мире (имманентное) | За Миром (трансцендентное) |
|----------|----------------------|----------------------------|
| **Author** | `character-author` — аллегория присутствия инженера в Мире | Инженер — создатель и оператор Системы |
| **AI** | `character-ai` — Персонаж со своими Воркбенчами и Каталогами | LLM-механизм Платформы (Track 5) |

**Author = Инженер + character-author**
- Инженер создаёт и поддерживает Систему
- character-author — его "аватар" в Мире
- Author может "видеть" Систему изнутри и снаружи

**AI = LLM-механизм + character-ai**
- LLM-механизм работает на уровне Платформы
- character-ai — его "представительство" в Мире
