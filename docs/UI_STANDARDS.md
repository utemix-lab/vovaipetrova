...
│ [виджет][виджет] [виджет][виджет] [виджет] │
│                                         │
│ ПРАКТИКИ (если есть)                    │
...
- **Содержит:** `.widget-group` с `.section-title` (T1) + виджеты
- **Отступы:** `--panel-inset` между группами, `--panel-inset-widgets` между виджетами

### Применение по типам страниц

| Тип | Блок 1 | Блок 2 | Блок 3 |
|-----|--------|--------|--------|
| **Character** | ✅ | ✅ Narrative | ✅ domains, workbenches, collabs |
